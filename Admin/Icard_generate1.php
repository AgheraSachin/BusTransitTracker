...
{
	$b=$_REQUEST['n2'];
	$a=mysql_query("select * from bus_pass_passenger where Pass_id='$b'") or die(mysql_error());
...
<html>
	...
	<body>
		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<table align="center">
					<tr>
				<td rowspan=8><img src="../<?php echo $p[9];?>" height="150px" width="120px"></td>
			</tr>
			<tr>
